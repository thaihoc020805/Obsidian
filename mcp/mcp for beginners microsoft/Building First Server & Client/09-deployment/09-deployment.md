...
- Evaluate(đánh giá) different deployment approaches.
- Deploy your app.
...
2. **Connect clients**: Use local connection URLs like `http://localhost:3000`
...
3. To try it locally, create a *mcp.json* file in a *.vscode* directory and add the following content:
