...
With the agent scaffolded(tạo khung), it’s time to define its personality and purpose. In this section, you’ll use the **Generate system prompt** feature to describe the agent’s intended behavior—in this case, a calculator agent—and have the model write the system prompt for you.

![[aitk-generate-prompt.png]]
...
![[aitk-add-mcp-server.png]]

AI Toolkit is equipped with templates for ease(dễ dàng) of creating your own MCP server. We'll use the Python template for creating the calculator MCP server.
...
![[aitk-agent-response-with-tools.png]]
