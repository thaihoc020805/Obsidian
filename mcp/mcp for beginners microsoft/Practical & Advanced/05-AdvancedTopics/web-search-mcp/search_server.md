...
SERPAPI_KEY = "0cbdc7dcee157d4ec3a92dc94dbaf26e24b5e715c61ee9eb66d17258fe558e01"

if not SERPAPI_KEY:

    logger.error(

        "SERPAPI_KEY environment variable not found. Please set it in .env file."
...
                f"Making SerpAPI request with engine: {params.get('engine', 'google')}"
...
    query: str, num_results: int = DEFAULT_RESULTS_LIMIT, ctx: Context = None
...
                    f"**Answer**: {' '.join(answer_box['snippet_highlighted_words'])}"
