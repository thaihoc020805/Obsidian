...
    session: ClientSession, tool_name: str, params: Dict[str, Any]
...
                    for content in readme_response.contents
...
            {"query": "latest AI trends 2025", "num_results": 3},
...
            session, "news_search", {"query": "AI policy updates", "num_results": 3}
...
            {"query": "best AI gadgets 2025", "num_results": 3},
...
    server_params = StdioServerParameters(command="python", args=["search_server.py"])
